...
public class MqttManagerAndroid {
    ...
    private final String brokerIPAdress = "mqtt.firstdecision.com.br";
    private final String brokerPort = "1883";
    private final String clientID = "MQTTSensorTAGFirst" + UUID.randomUUID().toString();;
    ...
    {
        try {
            getMqttAndroidClient().subscribe(topic, 1, null, new IMqttActionListener() {
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {

                    //Log.w(TAG,"Subscribed no topico: " + topic);
    ...
    public void publishMessage(String message,String topic)
    {
        try
        {
            ...
            getMqttAndroidClient().publish(topic,message.getBytes(),qos,false);
